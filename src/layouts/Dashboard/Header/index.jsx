                                        ...
                                        <ul id="form" class="iq-submenu collapse" data-parent="#otherpage">
                                            <li className="">
                                                <a href="form-layout.html">
                                                    <i class="las la-minus"></i><span className="">Form Elements</span>
                                                </a>
                                            </li>
                                            <li className="">
                                                <a href="form-input-group.html" class="svg-icon">
                                                    <i class="las la-minus"></i><span className="">Form Input</span>
                                                </a>
                                            </li>
                                            <li className="">
                                                <a href="form-validation.html" class="svg-icon">
                                                    <i class="las la-minus"></i><span className="">Form Validation</span>
                                                </a>
                                            </li>
                                            <li className="">
                                                <a href="form-switch.html" class="svg-icon">
                                                    <i class="las la-minus"></i><span className="">Form Switch</span>
                                                </a>
                                            </li>
                                            <li className="">
                                                <a href="form-chechbox.html" class="svg-icon">
                                                    <i class="las la-minus"></i><span className="">Form Checkbox</span>
                                                </a>
                                            </li>
                                            <li className="">
                                                <a href="form-radio.html" class="svg-icon">
                                                    <i class="las la-minus"></i><span className="">Form Radio</span>
                                                </a>
                                            </li>
                                            <li className="">
                                                <a href="form-textarea.html" class="svg-icon">
                                                    <i class="las la-minus"></i><span className="">Form Textarea</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
